	...
	<section class="container">
		<form:form  modelAttribute="newProduct" class="form-horizontal" enctype="multipart/form-data">
			<fieldset>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="productMan"> <spring:message
							code="addProdcut.form.productMan.label" />
					</label>
					<div class="col-lg-10">
						<form:input id="productMan" path="productMan" type="file"
							class="form:input-large" />
					</div>
				</div>
